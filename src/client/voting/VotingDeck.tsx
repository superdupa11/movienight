  ...
  return (
    <div className="relative flex h-screen flex-col overflow-hidden px-4 pb-6 pt-3.5">
      ...
      <div className="relative mt-5 flex items-center justify-center gap-[26px]">
        <button
          onClick={() => vote(false)}
          className="flex h-[58px] w-[58px] items-center justify-center rounded-full text-[22px] text-no transition hover:bg-[rgba(226,72,63,.12)] active:bg-[rgba(226,72,63,.12)] active:scale-95"
        ...
        <button
          onClick={() => vote(true)}
          className="flex h-[58px] w-[58px] items-center justify-center rounded-full text-[20px] text-yes transition hover:bg-[rgba(52,199,123,.12)] active:bg-[rgba(52,199,123,.12)] active:scale-95"
